...
import { ArrowLeft, TrendingUp, Calendar, Target, LucideIcon } from "lucide-react";

const arima = Arima({ subsets: ["latin"], weight: ["400", "700"], display: "swap" });

interface TraducaoEstatisticas {
  back: string;
  title: string;
  stat1: string;
  stat2: string;
...
const t: { pt: TraducaoEstatisticas; en: TraducaoEstatisticas } = {
  pt: {
